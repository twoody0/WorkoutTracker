    ...
    public class WorkoutPlanService : IWorkoutPlanService
    {
        ...
        public WorkoutPlanService(string? databasePath = null)
        {
            ...
            _plans.Add(new WorkoutPlan
            {
                ...
                Workouts = CreatePlanWorkouts(
                    Week(1,
                        RangeStrengthWorkout("Bench Press", 4, 6, 4, "Chest", DayOfWeek.Monday, targetRpe: 8.5, targetRestRange: "2-4 min"),
                        RangeStrengthWorkout("Bench Press", 1, 3, 1, "Chest", DayOfWeek.Monday, targetRpe: 9.5, targetRestRange: "3-5 min"),
                        StrengthWorkout("Barbell Row", 8, 4, "Back", DayOfWeek.Monday, targetRpe: 8, targetRestRange: "2-3 min"),
                    ...
                    Week(3,
                        RangeStrengthWorkout("Bench Press", 2, 4, 5, "Chest", DayOfWeek.Monday, targetRpe: 9, targetRestRange: "3-5 min"),
                        RangeStrengthWorkout("Bench Press", 1, 2, 1, "Chest", DayOfWeek.Monday, targetRpe: 9.5, targetRestRange: "3-5 min"),
                        StrengthWorkout("Barbell Row", 5, 4, "Back", DayOfWeek.Monday, targetRpe: 8.5, targetRestRange: "2-3 min"),
                        RangeStrengthWorkout("Push Press", 2, 4, 4, "Shoulders", DayOfWeek.Monday, targetRpe: 8.5, targetRestRange: "2-4 min"),
                        RangeStrengthWorkout("Weighted Pull-Up", 1, 3, 4, "Back", DayOfWeek.Monday, targetRpe: 9, targetRestRange: "2-4 min"),
            ...
            _plans.Add(new WorkoutPlan
            {
                ...
                Workouts = CreatePlanWorkouts(
                    Week(1,
                        ...
                        StrengthWorkout("Cable Lateral Raise", 15, 3, "Shoulders", DayOfWeek.Thursday),
                        StrengthWorkout("Overhead Triceps Extension", 12, 3, "Arms", DayOfWeek.Thursday),
                        RangeStrengthWorkout("Dips", 8, 10, 2, "Chest", DayOfWeek.Thursday),
                        RangeStrengthWorkout("Cable Chest Fly", 12, 15, 2, "Chest", DayOfWeek.Thursday),
                    ...
                    Week(2,
                        ...
                        StrengthWorkout("Weighted Pull-Up", 6, 4, "Back", DayOfWeek.Tuesday, targetRpe: 8.5, targetRestRange: "2-3 min"),
                        ...
                        StrengthWorkout("Cable Lateral Raise", 15, 3, "Shoulders", DayOfWeek.Thursday),
                        StrengthWorkout("Dips", 10, 3, "Chest", DayOfWeek.Thursday),
                        StrengthWorkout("Cable Triceps Pushdown", 12, 3, "Arms", DayOfWeek.Thursday),
                        RangeStrengthWorkout("Cable Chest Fly", 12, 15, 2, "Chest", DayOfWeek.Thursday),
                        ...
                        StrengthWorkout("Rear-Foot Elevated Split Squat", 10, 3, "Legs", DayOfWeek.Saturday, targetRpe: 7.5, targetRestRange: "1-2 min"),
                    ...
                    Week(3,
                        ...
                        RangeStrengthWorkout("Dips", 6, 8, 2, "Chest", DayOfWeek.Thursday),
                        RangeStrengthWorkout("Weighted Pull-Up", 1, 3, 4, "Back", DayOfWeek.Friday, targetRpe: 9, targetRestRange: "3-4 min"),
                    ...
                    Week(4,
                        ...
                        RangeStrengthWorkout("Cable Chest Fly", 15, 20, 2, "Chest", DayOfWeek.Thursday),
