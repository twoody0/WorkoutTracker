...
public static class ExerciseInfoCatalog
{
    ...
    private static readonly Dictionary<string, ExerciseInfo> ExactInfoMap = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["Sit-Up"] = Create("Builds the abs through a fuller trunk flexion range than a crunch.", "Lie on your back with knees bent and feet anchored or planted.", "Brace lightly and curl all the way up without yanking through the neck.", "Lower back down under control instead of dropping."),
        ["Incline Sit-Up"] = Create("Builds the abs with extra challenge from the decline angle.", "Set the bench securely and anchor the feet before starting.", "Curl the torso up smoothly while keeping the movement controlled.", "Lower back down slowly without losing tension at the bottom."),
        ...
        ["Cable Crunch"] = Create("Builds the abs with constant cable resistance through spinal flexion.", "Kneel far enough from the stack to keep tension on the rope.", "Curl the ribcage down toward the pelvis instead of just moving the hips.", "Return slowly until the abs are lengthened again."),
        ...
        ["Reverse Crunch"] = Create("Builds the lower abs by curling the pelvis toward the ribs.", "Lie on your back and bring the knees up over the hips.", "Curl the pelvis off the floor instead of only swinging the legs.", "Lower back down under control and reset before the next rep."),
        ...
        ["Toe Touches"] = Create("Builds the abs by reaching upward through a compact crunch pattern.", "Lie on your back with the legs raised and brace before moving.", "Reach the hands toward the toes by curling the upper back off the floor.", "Lower slowly without losing tension completely between reps."),
